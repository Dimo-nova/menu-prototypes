...
const categoryIconMap = {
  ...
  "patatas fritas": "fa-french-fries",
  quesos: "fa-cheese",
...
const mapMenuData = (raw) => {
  ...
  return {
    sliders: [
      {
        id: "slide-hero-burger",
        tag: "Especialidad",
        title: "Hamburguesa de la casa",
        description: "Carne jugosa, pan tostado y salsa Pakito.",
        imageUrl: "../../data/images/dishes/hamburguesas/hero-burguer.jpg",
      },
      {
        id: "slide-new-york",
        tag: "Burger",
        title: "New York Burguer",
        description: "Doble queso, pepinillos y toque ahumado.",
        imageUrl: "../../data/images/dishes/hamburguesas/new-york.jpg",
      },
      {
        id: "slide-croquetas",
        tag: "Raciones",
        ...
        imageUrl: "../../data/images/dishes/entrantes/croquetas.jpg",
      }
    ],
    categories,
    dishes,
